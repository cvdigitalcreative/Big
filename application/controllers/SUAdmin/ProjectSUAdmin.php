 ...
 * 
 */
class ProjectSUAdmin extends CI_Controller
{
	...
	function index(){
		if($this->session->userdata("akses") == 5){	
			...
			$this->load->view('SuAdmin/v_project_admin',$x);
		}else{
			redirect("Login");
		}
	}
	...
	function detailforAdmin($kode)
	{
		if($this->session->userdata("akses") == 5){	
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_project_detail_admin',$x);
		}else{
			redirect("Login");
		}
	}
	...
	function LihatBQ($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_bq',$x);
		}else{
			redirect("Login");
		}	
	}
	...
	function LihatJadwal($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_jadwal',$x);
		}else{
			redirect("");
		}	
	}
	...
	function LihatPermintaanBarang($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_permintaan_barang',$x);
		}else{
			redirect("Login");
		}	
	}
	...
	function LihatLaporanKeuangan($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_keuangan',$x);
		}else{
			redirect("Login");
		}	
	}
	...
	function LihatLaporanMaterial($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_material',$x);
		}else{
			redirect("Login");
		}	
	}
	...
	function LihatLaporanUpah($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/v_lihat_upah',$x);
		}else{
			redirect("Login");
		}	
	}
	...
	function cetakPermintaanBarang($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/cetak_permintaan_barang',$x);
		}else{
			redirect("Login");
		}
	}
	...
	function cetakLaporanKeuangan($kode){
		if($this->session->userdata("akses") == 5){
			...
			$this->load->view('v_header_su',$y);
			$this->load->view('SuAdmin/v_sidebar');
			$this->load->view('SuAdmin/cetak_laporan_keuangan',$x);
		}else{
			redirect("Login");
		}
	}
