...
<!--=================================
 ...
 <!--=================================
 login-->
<section class="height-100vh d-flex align-items-center page-section-ptb login" style="background-image: url(<?php echo base_url()?>assets/admin/images/pengacara.jpg); background-repeat: no-repeat; background-size: 100% 100%" >
  <div class="container">
    <div class="row justify-content-center no-gutters vertical-align">
      <div class="col-lg-4 col-md-6 login-fancy-bg bg">
        <div class="login-fancy">
          ...
          <a href="<?php echo base_url()?>LoginSurveyor"><button class="btn btn-danger mb-10" style="margin-left: 10px">Surveyor</button></a>
          ...
          <a href="<?php echo base_url()?>Login_Sales"><button class="btn btn-primary mb-10" style="margin-left: 10px">Sales</button></a>
    ...
    <div class="col-lg-4 col-md-6 bg-white">
        <div class="login-fancy pb-40 clearfix">
          <h3 class="mb-30">Log In Sales</h3>
          <div>
            <p><?php echo $this->session->flashdata('msg');?></p>
          </div>
          <form action="<?php echo base_url().'Login_Sales/authadmin'?>" method="post" role="form" name="loginForm" novalidate="">
