...
function showDiv(elem)
{
  if(elem.value == 1){
    ...
    document.getElementById("suadmin").style.display = "none";
  }
...
function divAdmin(){
    var x = document.getElementById("surveyor");
    var y = document.getElementById("qc");
    var z = document.getElementById("pengawas");
    var a = document.getElementById("suadmin");
