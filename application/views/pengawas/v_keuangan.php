        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Pengawas/Keuangan/save_laporan" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control form-white" placeholder="200000" type="number" name="uang_masuk" required/>
                                </div>
                                <div class="col-md-12">
                                    <label class="control-label">Uang Keluar</label>
                                    <input class="form-control form-white" placeholder="200000" type="number" name="uang_keluar" required/>
                                </div>
                                <div class="col-md-12">
