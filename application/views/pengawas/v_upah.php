        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
            <ul class="nav nav-tabs mb-10">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url()?>Pengawas/Keuangan/laporan_upah/<?php echo $proyek_id;?>">Upah</a>
                </li>
              </ul>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Pengawas/Keuangan/save_upah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="bahan">
                                        <option selected value="">Pilih</option>
                                         <?php
                                            $no=0;
                                            foreach ($data_upah->result_array() as $i) :
                                              $no++;
                                                 $bahan=$i['du_jenis_pekerjaan'];
                                              ?>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="EditData<?php echo $id?>">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Pengawas/Keuangan/update_upah" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <select class="form-control" name="bahan">
                                  <option selected value="">Pilih</option>
