        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Pengawas/ProjectPengawas/permintaanBarang" method="post" enctype="multipart/form-data">
                          <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label">Nama Barang</label>
                                    <input type="hidden" name="kode" value="<?php echo $row->proyek_id;?>">
                                    <input type="hidden" name="nama_proyek" value="<?php echo $row->proyek_nama;?>">
                                    <input class="form-control form-white" placeholder="Nama Barang " type="text" name="xnamabarang" required/>
                                </div>
                                <div class="col-md-12">
                                    <label class="control-label">Spesifikasi</label>
                                    <input class="form-control form-white" placeholder="Masukkan Spesifikasi" type="text" name="xspesifikasi" required/>
                                </div>
                                <div class="col-md-12">
                                  <label class="control-label">Jumlah Dan Satuan</label>
                                  <div class="row">
                                    <div class="col-md-6">
                                      <input type="number" name="xjumlah" id="jumlah" class="form-control" placeholder="Jumlah">
                                    </div>
                                    <div class="col-md-6">
                                      <input type="text" name="xsatuan" id="satuan" class="form-control" placeholder="Satuan">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-12">
                                    <label class="control-label">Rencana Pemakaian</label>
                                    <textarea rows="4" class="form-control form-white" name="xpemakaian">Masukkan Rencana pemakaiannya</textarea>    
                                </div>
                            </div>          
                        </div>
...
<?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Permintaan barang diterma,Silahkan ditunggu konfirmasi dari admin.",
