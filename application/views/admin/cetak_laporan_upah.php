 ...
 <div class="content-wrapper">
     ...
     <div id="spk" hidden>
         <h3><center>LAPORAN KEUANGAN KEUANGAN UPAH</center></h3>
          ...
          <br>
             <table border="1" cellpadding="10" width="800">
              ...
              <tr>
                ...
                <td><center><?php echo $row->lu_keterangan;?></td>
                <td><center><?php echo $row->lu_uang_masuk;?></td>
                <td><center><?php echo $row->lu_uang_keluar;?></td>
                <td><center><?php echo $row->lu_sisa_uang;?></td>
              </tr>
              <?php endforeach;?>
