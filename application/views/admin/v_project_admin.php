  ...
  <div class="content-wrapper" id="content" style="display: block;">
    ...
    <div class="row" id="phase" style="display: flex;">   
      ...
      <div class="col-sm-6 col-lg-6 col-xl-4 mb-30">     
        <div class="card card-statistics h-100"> 
          <div class="card-body">   
            <a href="<?php echo base_url()?>Admin/ProjectAdmin/detailforAdmin/<?php echo $proyek_id?>" class="text-dark float-right" data-toggle="tooltip" data-placement="left" title="" data-original-title="Lihat Proyek" target="_blank" style="margin-left: 5px"><i class="fa fa-eye"></i></a>
   ...
   <div class="row" id="progress" style="display: none;">   
      ...
      <div class="col-sm-6 col-lg-6 col-xl-4 mb-30">     
        <div class="card card-statistics h-100"> 
          <div class="card-body">   
            <a href="<?php echo base_url()?>Admin/ProjectAdmin/detailforAdmin/<?php echo $proyek_id?>" class="text-dark float-right" data-toggle="tooltip" data-placement="left" title="" data-original-title="View project" target="_blank"><i class="fa fa-eye"></i></a>
            <span><?php echo $proyek_petugas;?></span>
            <h5 class="mt-15 mb-15"><b><?php echo $proyek_nama;?></b></h5>
            <div class="mt-20">
             <div class="clearfix">
