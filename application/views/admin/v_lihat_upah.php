        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
            <ul class="nav nav-tabs mb-10">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url()?>Admin/ProjectAdmin/LihatLaporanKeuangan/<?php echo $proyek_id;?>">Koordinator</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url()?>Admin/ProjectAdmin/LihatLaporanMaterial/<?php echo $proyek_id;?>">Material</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url()?>Admin/ProjectAdmin/LihatLaporanUpah/<?php echo $proyek_id;?>">Upah</a>
                </li>
              </ul>
            <div class="col-xl-4 mb-10">
                  <a href="<?php echo base_url()?>Admin/ProjectAdmin/cetakLaporanUpah/<?php echo $row->proyek_id;?>" class="btn btn-primary btn-block ripple m-t-20">
            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              <tbody>
                  <?php foreach ($data_laporan->result_array() as $i) :
                      $id            = $i['lu_id'];
                      $bahan         = $i['lu_jenis_pekerjaan'];
                      $tanggal       = $i['tanggal'];
                      $pengirim      = $i['lu_pengirim'];
                      $keterangan    = $i['lu_keterangan'];
                      $uang_masuk    = $i['lu_uang_masuk'];
                      $uang_keluar   = $i['lu_uang_keluar'];
                      $sisa_uang     = $i['lu_sisa_uang'];
                      $nota          = $i['lu_nota'];
                  ?>
                  <tr>
