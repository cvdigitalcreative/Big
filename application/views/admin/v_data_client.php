              ...
              <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $id=$i['id_client'];
                       $nama=$i['nama_client'];
                       $perusahaan_client=$i['perusahaan_client'];
                  ...
                  <tr>
                      <td><?php echo $no ?></td>
                      <td><?php echo $nama?></td>
                      <td><?php echo $perusahaan_client?></td>
      ...
      <!-- Modal Add Data -->
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Sales/Home/addclient" method="post" enctype="multipart/form-data">
                      <div class="modal-body p-20">
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      ...
                                      <input class="form-control form-white" placeholder="Masukkan Password" type="text" name="xpassword" />
                                  </div>
                                  <div class="col-md-12">
        ...
        <?php
          ...
          foreach ($data->result_array() as $i) :
            ...
            $id=$i['id_client'];
            $nama=$i['nama_client'];
            $perusahaan_cliet=$i['perusahaan_client'];
                          ...
                          <div class="modal-body p-20">
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      ...
                                      <input class="form-control form-white" placeholder="Masukkan nomor hp" type="number" name="xhp" value="<?php echo $perusahaan_client;?>" required/>
                                  </div>
                                  <div class="col-md-12">
                                      <label class="control-label">Alamat Rumah</label>
                                      <textarea rows="4" class="form-control form-white" name="xalamat"><?php echo $jabatan_client;?></textarea>
                                  </div>
                                  <div class="col-md-12">
                                      <label class="control-label">Username</label>
                                      <input class="form-control form-white" placeholder="Masukkan Username" type="text" name="xusername" value="<?php echo $contact_person;?>" required/>
                                  </div>
