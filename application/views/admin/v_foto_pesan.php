        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">   
            <div class="row1">
              ...
              <div class="d-block">
                <h5 class="mb-10 mt-30 card-title border-0 pb-0">Foto Pesan / Chatting</h5>
              </div>            
              <div class="column1">
                <?php foreach ($foto_pesan->result() as $row): ?>
                  <img class="mb-2" src="<?php echo base_url()?>assets/foto_pekerjaan/<?php echo $row->fpe_foto;?>" alt="Lights" style="width:14%;height: 14%;" onclick="myFunction(this);">
                <?php endforeach; ?>
              </div>             
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah data foto pesan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <form action="<?php echo base_url()?>Admin/ProjectAdmin/simpan_foto" method="post" enctype="multipart/form-data">
