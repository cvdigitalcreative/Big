        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
            <ul class="nav nav-tabs mb-10">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url()?>Admin/ProjectAdmin/LihatLaporanMaterial/<?php echo $proyek_id;?>">Material</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url()?>Admin/ProjectAdmin/LihatLaporanUpah/<?php echo $proyek_id;?>">Upah</a>
                </li>
              </ul>
