        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Asets/Aset/adddatapeminjam" method="post" enctype="multipart/form-data">
                      <div class="modal-body p-20">
                              <div class="row">

                                  <div class="col-md-12">
                                      <label class="control-label">Nama Peminjam</label>
                                      <input class="form-control form-white" placeholder="Masukkan Nama Peminjam" type="text" name="nama" required/>
                                  </div>
                                  <div class="col-md-12">
                                    ...
                                    <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="id" required>
                                       <option selected value="">Choose...</option>
                                          <?php
                                              $no=0;
                                              foreach ($data_aset->result_array() as $i) :
                                              $no++;
                                              $id=$i['id_aset'];
                                              $nama_barang=$i['nama_barang'];
                                          ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php echo base_url().'Asets/Aset/edit_datapeminjam'?>" method="post" enctype="multipart/form-data">
                          <div class="modal-body p-20">
                              <div class="row">
                                  <div class="col-md-12">
                                      <label class="control-label">Nama Peminjam</label>
                                      <input type="hidden" name="id" value="<?php echo $id ?>">
                                      <input type="text" class="form-control form-white" placeholder="Tanggal" name="nama" value="<?= $nama_peminjam ?>" required/>
                                  </div>

                                   <div class="col-md-12">
                                       <label>Nama Barang</label>
                                    <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="id_aset" required/>
                                          <?php
                                              $no=0;
                                              foreach ($data_aset->result_array() as $i) :
                                              $no++;
                                  ...
                                  <div class="col-md-12">
                                      <label class="control-label">Tanggal Pinjam</label>
                                      <input type="date" class="form-control form-white" placeholder="Tanggal" name="tanggal" value="<?php echo $tanggal ?>" required/>
                                  </div>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="HapusData<?php echo $id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Asets/Aset/hapuspeminjam" method="post" enctype="multipart/form-data">
                        <div class="modal-body p-20">                     
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="id" value="<?php echo $id;?>">
                                    <input type="hidden" name="foto_lama" value="<?php echo $foto_barang ?>"> 
                                    <p>Apakah kamu yakin ingin menghapus Data Peminjam <b><i><?php echo $nama_peminjam?></i></b></p>
                                </div>
                            </div>                  
                        </div>
                        <div class="modal-footer">
