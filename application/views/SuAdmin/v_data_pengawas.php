              ...
              <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id=$i['pengawas_id'];
                       $nama=$i['pengawas_nama'];
                       $alamat=$i['pengawas_alamat'];
                       $hp=$i['pengawas_hp'];
                       $username=$i['pengawas_username'];
                       $password=$i['pengawas_password'];
                       $foto=$i['pengawas_foto'];
                  ?>
                  <tr>
                    <?php if(empty($foto)):?>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>SUAdmin/Data_User/addPengawas" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php echo base_url()?>SUAdmin/Data_User/editPengawas" method="post" enctype="multipart/form-data">
                          <div class="modal-body p-20">
                              <div class="row">
                                  <div class="col-md-12">
                                      <label class="control-label">Nama Lengkap</label>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="HapusData<?php echo $id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>SUAdmin/Data_User/hapusPengawas" method="post" enctype="multipart/form-data">
                        <div class="modal-body p-20">                     
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="kode" value="<?php echo $id;?>">
                                    <input type="hidden" name="gambar" value="<?php echo $foto;?>">
                                    <p>Apakah kamu yakin ingin menghapus pengawas <b><i><?php echo $nama?></i></b></p>
                                </div>
                            </div>                  
                        </div>
                        <div class="modal-footer">
