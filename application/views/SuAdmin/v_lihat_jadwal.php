      ...
      <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/detailforAdmin/<?php echo $proyek_id;?>" class="default-color">Project Summary</a></li>
            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/download_jadwal/<?php echo $id?>"><i class="fa fa-download"></i></a></td>
                  </tr>
                  <?php endforeach; ?> 
              </tbody>
           </table>
