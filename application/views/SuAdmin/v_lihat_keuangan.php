        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
             <ul class="nav nav-tabs mb-10">
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/LihatLaporanKeuangan/<?php echo $proyek_id;?>">Koordinator</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-xl-4 mb-10">
                  <a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/cetakLaporanKeuangan/<?php echo $row->proyek_id;?>" class="btn btn-primary btn-block ripple m-t-20">
