      ...
      <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
              ...
              <li class="breadcrumb-item active">Input Data BQ</li>
            </ol>
          </div>
          <?php endforeach; ?> 
        </div>
            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/download_bq/<?php echo $id?>"><i class="fa fa-download"></i></a></td>
                  </tr>
                  <?php endforeach; ?> 
              </tbody>
           </table>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>QC/ProjectQC/simpan_file_bq" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                      <div class="form-group">
                        <label for="BQ / Analisis Harga">BQ / Analisis Harga</label>
                        <input type="hidden" name="kode" value="<?php echo $proyek_id;?>">
                        <input  class="form-control" type="file" name="bq" />
                      </div>            
                    </div>
