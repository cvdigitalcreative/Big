        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
            <ul class="nav nav-tabs mb-10">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/LihatLaporanMaterial/<?php echo $proyek_id;?>">Material</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/LihatLaporanUpah/<?php echo $proyek_id;?>">Upah</a>
                </li>
              </ul>
            <div class="col-xl-4 mb-10">
                  <a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/cetakLaporanUpah/<?php echo $row->proyek_id;?>" class="btn btn-primary btn-block ripple m-t-20">
