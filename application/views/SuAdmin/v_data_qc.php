              ...
              <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $alamat=$i['qc_alamat'];
                       $hp=$i['qc_hp'];
                       $username=$i['qc_username'];
                       $password=$i['qc_password'];
                       $foto=$i['qc_foto'];
                  ?>
                  <tr>
                    <?php if(empty($foto)):?>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="tambah-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>SUAdmin/Data_User/addQC" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php echo base_url()?>SUAdmin/Data_User/editQC" method="post" enctype="multipart/form-data">
                          <div class="modal-body p-20">
                              <div class="row">
                                  <div class="col-md-12">
                                      <label class="control-label">Nama Lengkap</label>
                        ...
                        <div class="modal-body p-20">                     
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p>Apakah kamu yakin ingin menghapus user quality control <b><i><?php echo $nama?></i></b></p>
                                </div>
                            </div>                  
                        </div>
                        <div class="modal-footer">
