          ...
          <div class="card card-statistics mb-30"> 
            <div class="card-body">
              <h5 class="card-title">Apakah proyek ini bisa dilanjutkan?</h5>
               <a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/ubah_status2/<?php echo $row->proyek_id;?>"><button class="btn btn-primary mb-10">Bisa dilanjutkan</button></a>
               <a href="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/ubah_status0/<?php echo $row->proyek_id;?>"><button class="btn btn-danger mb-10">Tidak bisa dilanjutkan</button></a>
            </div>
          </div>
        <?php else:?>
      ...
      <div class="col-xl-4 mb-30">
        ...
        <div class="card card-statistics mb-30"> 
          <div class="card-body">
            ...
            <form action="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/updateTglPenawaran/<?php echo $row->proyek_id;?>" method="post">
        ...
        <div class="card card-statistics mb-30"> 
          <div class="card-body">
            ...
            <form action="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/updateTglSPK/<?php echo $row->proyek_id;?>" method="post">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="add-user">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php foreach ($data->result() as $row): ?> 
                    <form action="<?php echo base_url()?>SUAdmin/ProjectSUAdmin/updateuserQC/<?php echo $row->proyek_id;?>" method="post">
