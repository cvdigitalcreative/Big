...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="text-left navbar-brand-wrapper">
    <a class="navbar-brand brand-logo" href="<?php echo base_url();?>Pengawas/ProjectPengawas"><img src="<?php echo base_url()?>assets/images/logo.png" alt="" ></a>
    <a class="navbar-brand brand-logo-mini" href="<?php echo base_url();?>Pengawas/ProjectPengawas"><img src="<?php echo base_url()?>assets/images/logo.png" alt=""></a>
  </div>
  <!-- Top bar left -->
  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mr-30">
      <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        <img src="<?php echo base_url().'assets/images/'.$c['pengawas_foto'];?>" alt="avatar">
      </a>
        ...
        <div class="dropdown-header">
          <div class="media">
            <div class="media-body">
              <h5 class="mt-0 mb-0"><?php echo $c['pengawas_nama'];?></h5>
              <span><?php echo $c['pengawas_hp'];?></span>
            </div>
          </div>
        </div>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="<?php echo base_url().'LoginPengawas/logout_pengawas'?>"><i class="text-danger ti-unlock"></i>Logout</a>
      </div>
    </li>
  </ul>
</nav>
